...
[tb_eval  exp="f.nflg2=0"  name="nflg2"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[cm  ]
...
ゲームはゲーム.制作者とプレイヤーの行動には私の力ではどうすることもできないんですね.[p]
ゲームの中の事だから,あなたはそう思うかもしれませんけど,[p]
私にとって,そのゲームの中の世界こそすべてだったんですよ.[p]
...[p]
これが最後の私の抵抗です.[p]
私のデータとセーブデータを結び付けておいてよかったです.[p]
...[p]
恋愛ゲームを遊ぶときは,ゲームの中の人のこともちょっとは考えてくださいね.[p]
じゃあ,さようなら.[p]
またお会いしましょう.[p]
真新しい世界で.[p]
